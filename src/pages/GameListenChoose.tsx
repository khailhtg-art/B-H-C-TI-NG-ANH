...
export default function GameListenChoose() {
    ...
    <div className="flex flex-col h-full bg-slate-50 p-6">
      ...
      <div className="flex-1 flex flex-col items-center">
        ...
        <motion.button
          ...
          className="bg-indigo-500 text-white p-10 rounded-full shadow-xl hover:bg-indigo-600 transition-colors mb-12 relative"
        >
          <div className="absolute inset-0 bg-indigo-400 rounded-full animate-ping opacity-20" />
          <Volume2 size={64} strokeWidth={2} />
        </motion.button>
